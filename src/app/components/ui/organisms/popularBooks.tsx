  ...
  return (
    ...
    >
      ...
      <div className="p-3 bg-white rounded-md text-center">
        <h3 className="italic font-bold truncate text-purple-900 font-akaya-kanadaka text-xl md:text-lg">
          {book.title}
        </h3>
        <p className="text-lg font-akaya-kanadaka text-purple-800">
          {book.author}
        </p>
