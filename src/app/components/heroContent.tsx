    ...
    <div className="w-full flex flex-col items-center justify-center space-y-4">
      ...
      >
        <div className="flex flex-col sm:flex-row gap-3">
          <Link href="/books">
            <Button className="bg-blue-300 hover:bg-blue-200 text-purple-900 rounded-lg relative overflow-hidden group w-full px-8">
              <span className="relative  text-purple-900 font-akaya-kanadaka text-xl tracking-wider z-10">Explore Magical Books</span>
          ...
          <Link href="/sign-up">
            <Button className="bg-purple-400 hover:bg-purple-300 text-blue-900  rounded-lg relative overflow-hidden group w-full px-8">
              <span className="relative text-blue-900   font-akaya-kanadaka text-lg tracking-wider z-10">Begin Your Adventure</span>
